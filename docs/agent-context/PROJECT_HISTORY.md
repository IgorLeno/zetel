# Histórico consolidado do contexto de agentes — Zetel

> Arquivo integral extraído do antigo `AGENTS.md` em 2026-08-03 pela tarefa
> SPEC-000/002C. Mantido como referência histórica; não carregar por padrão.
...
### Dívidas técnicas por módulo (não bloqueiam gate)
...
finito e positivo e autorização humana explícita; roda fora dos gates padrão e
nunca é executado automaticamente pela CI padrão.
