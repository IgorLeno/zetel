# Histórico do contexto específico do Claude — Zetel

> Arquivo integral extraído do antigo `CLAUDE.md` em 2026-08-03 pela tarefa
> SPEC-000/002C. Preserva diferenças históricas do adapter; não carregar por
> padrão.
